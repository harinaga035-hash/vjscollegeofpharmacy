...
function TopBar() {
  return /* @__PURE__ */ jsx("div", {
    className: "hidden md:block bg-[var(--navy-deep)] text-white text-[13px]", children: /* @__PURE__ */ jsxs("div", {
      className: "mx-auto max-w-7xl px-6 h-10 flex items-center justify-between", children: [
    /* @__PURE__ */ jsxs("div", {
      ...
      /* @__PURE__ */ jsxs("a", {
          href: "tel:+919876543210", className: "flex items-center gap-1.5 hover:text-[var(--gold)] transition-colors", children: [
        /* @__PURE__ */ jsx(Phone, { className: "h-3.5 w-3.5" }),
            " +91 98765 43210"
          ]
        }),
      /* @__PURE__ */ jsxs("a", {
          href: "mailto:admissions@vjpharmacy.edu.in", className: "flex items-center gap-1.5 hover:text-[var(--gold)] transition-colors", children: [
    ...
    /* @__PURE__ */ jsxs("div", {
      ...
      /* @__PURE__ */ jsxs("a", {
          href: "#admission", className: "ml-2 inline-flex items-center gap-1 bg-[var(--gold)] text-[var(--navy-deep)] px-3 py-1 rounded-full font-button font-semibold text-xs hover:brightness-110 transition", children: [
            "Apply Now ",
...
function Nav() {
  ...
  return /* @__PURE__ */ jsxs("header", {
    className: `fixed top-0 md:top-10 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? "bg-white/95 backdrop-blur-xl shadow-[0_4px_30px_-10px_rgba(10,37,64,0.15)]" : "bg-transparent"}`, children: [
    /* @__PURE__ */ jsxs("div", {
      className: "mx-auto max-w-7xl px-6 h-20 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxs("a", {
        href: "#", className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsx("div", { className: `h-11 w-11 rounded-xl grid place-items-center font-display font-black text-lg shadow-premium ${scrolled ? "bg-[var(--navy)] text-[var(--gold)]" : "bg-white/15 text-white backdrop-blur-md border border-white/30"}`, children: /* @__PURE__ */ jsx("img", { src: logo, alt: "VJ's College of Pharmacy" }) }),
        /* @__PURE__ */ jsxs("div", {
      ...
      /* @__PURE__ */ jsx("nav", {
        className: "hidden lg:flex items-center gap-1", children: items.map((it) => /* @__PURE__ */ jsxs("a", {
          href: `#${it.toLowerCase()}`, className: `relative px-3 py-2 text-[13.5px] font-medium transition-colors group ${scrolled ? "text-[var(--ink)] hover:text-[var(--navy)]" : "text-white/90 hover:text-white"}`, children: [
            it,
    ...
    /* @__PURE__ */ jsxs("div", {
      className: `fixed inset-0 z-[60] lg:hidden transition-all duration-500 ${open ? "visible opacity-100" : "invisible opacity-0"}`, children: [
      /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-[var(--navy-deep)]", onClick: () => setOpen(false) }),
      /* @__PURE__ */ jsxs("div", {
        className: `absolute inset-y-0 right-0 w-full max-w-sm bg-[var(--navy)] text-white p-8 transition-transform duration-500 ${open ? "translate-x-0" : "translate-x-full"}`, children: [
        /* @__PURE__ */ jsxs("div", {
          className: "flex items-center justify-between mb-10", children: [
        ...
        /* @__PURE__ */ jsx("nav", {
          className: "flex flex-col gap-1", children: items.map((it, i) => /* @__PURE__ */ jsxs("a", {
            href: `#${it.toLowerCase()}`, onClick: () => setOpen(false), className: "group flex items-center justify-between py-4 border-b border-white/10 text-lg font-display", style: { transitionDelay: `${i * 40}ms` }, children: [
        ...
        /* @__PURE__ */ jsxs("a", {
          href: "#admission", onClick: () => setOpen(false), className: "mt-10 inline-flex w-full justify-center items-center gap-2 bg-[var(--gold)] text-[var(--navy-deep)] font-button font-semibold py-4 rounded-full", children: [
            "Apply Now ",
...
function Hero() {
  return /* @__PURE__ */ jsxs("section", {
    id: "home", className: "relative min-h-screen flex items-center overflow-hidden", children: [
    /* @__PURE__ */ jsxs("div", {
    ...
    /* @__PURE__ */ jsxs("div", {
      className: "relative z-10 mx-auto max-w-7xl px-6 pt-32 pb-16 grid lg:grid-cols-12 gap-10 items-center w-full", children: [
      /* @__PURE__ */ jsxs(Reveal, {
        className: "lg:col-span-7 text-white", children: [
        /* @__PURE__ */ jsxs("div", {
          className: "inline-flex items-center gap-2 px-4 py-1.5 rounded-full glass text-xs font-medium tracking-wider uppercase", children: [
          /* @__PURE__ */ jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-[var(--gold)] animate-pulse" }),
            " PCI Approved \xB7 Estd. 2007"
          ]
        }),
        /* @__PURE__ */ jsxs("h1", {
          className: "font-display font-black mt-6 text-[44px] sm:text-6xl lg:text-7xl leading-[1.02] tracking-tight", children: [
            "Building Future ",
        ...
        /* @__PURE__ */ jsxs("div", {
          ...
          /* @__PURE__ */ jsxs("a", {
            href: "#admission", className: "group inline-flex items-center gap-2 bg-[var(--gold)] text-[var(--navy-deep)] font-button font-semibold px-7 py-4 rounded-full shadow-gold-glow hover:-translate-y-0.5 transition-all", children: [
              "Apply for 2026 ",
            /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4 group-hover:translate-x-1 transition" })
            ]
          }),
          /* @__PURE__ */ jsxs("a", {
            href: "#tour", className: "group inline-flex items-center gap-2 glass text-white font-button font-medium px-7 py-4 rounded-full hover:bg-white/15 transition", children: [
        ...
        /* @__PURE__ */ jsxs("div", {
          className: "mt-10 flex flex-wrap items-center gap-x-8 gap-y-3 text-sm text-white/75", children: [
          /* @__PURE__ */ jsxs("span", {
      ...
      /* @__PURE__ */ jsx(Reveal, {
        delay: 200, className: "lg:col-span-5", children: /* @__PURE__ */ jsxs("div", {
          className: "glass rounded-3xl p-8 lg:p-10 text-white shadow-premium", children: [
        /* @__PURE__ */ jsxs("div", {
        ...
        /* @__PURE__ */ jsx("div", {
            className: "grid grid-cols-2 gap-6", children: [
              ...
              className: "border-l-2 border-[var(--gold)]/50 pl-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", {
            className: "mt-8 pt-6 border-t border-white/15 flex items-center justify-between text-sm", children: [
...
function Metrics() {
  ...
  return /* @__PURE__ */ jsx("section", {
    className: "bg-white py-20 border-b border-[var(--navy)]/5", children: /* @__PURE__ */ jsx("div", {
      className: "mx-auto max-w-7xl px-6", children: /* @__PURE__ */ jsx("div", {
        className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8", children: m.map((x) => /* @__PURE__ */ jsx(Reveal, {
...
function Highlights() {
  ...
  return /* @__PURE__ */ jsxs("section", {
    className: "relative py-20 bg-[var(--surface)] overflow-hidden", children: [
    /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(10,37,64,0.04),transparent_60%)]" }),
    /* @__PURE__ */ jsx("div", {
      className: "mx-auto max-w-7xl px-6 relative", children: /* @__PURE__ */ jsx("div", {
        className: "grid md:grid-cols-2 lg:grid-cols-4 gap-6", children: items.map((it, i) => /* @__PURE__ */ jsx(Reveal, {
          delay: i * 80, children: /* @__PURE__ */ jsxs("div", {
            className: "group relative h-full bg-white rounded-2xl p-8 border border-[var(--navy)]/8 hover:border-[var(--gold)]/40 transition-all duration-500 hover:-translate-y-2 hover:shadow-gold-glow", children: [
...
function About() {
  return /* @__PURE__ */ jsx("section", {
    id: "about", className: "py-28 bg-white", children: /* @__PURE__ */ jsxs("div", {
      className: "mx-auto max-w-7xl px-6 grid lg:grid-cols-2 gap-16 items-center", children: [
    /* @__PURE__ */ jsx(Reveal, {
        children: /* @__PURE__ */ jsxs("div", {
      ...
      /* @__PURE__ */ jsxs("div", {
            className: "absolute -bottom-8 -left-6 lg:left-8 bg-white rounded-2xl shadow-premium p-5 flex items-center gap-4 max-w-[280px]", children: [
    ...
    /* @__PURE__ */ jsxs(Reveal, {
      ...
      /* @__PURE__ */ jsxs("h2", {
          className: "font-display font-black text-4xl lg:text-5xl text-[var(--navy)] mt-3 leading-tight", children: [
      ...
      /* @__PURE__ */ jsxs("p", {
          className: "mt-6 text-[var(--muted-ink)] leading-relaxed", children: [
      ...
      /* @__PURE__ */ jsx("div", {
          className: "mt-8 grid grid-cols-2 gap-5 max-w-md", children: [
      ...
      /* @__PURE__ */ jsxs("a", {
          href: "#", className: "mt-10 inline-flex items-center gap-2 font-button font-semibold text-[var(--navy)] border-b-2 border-[var(--gold)] pb-1 hover:gap-3 transition-all", children: [
            "Read Our Full Story ",
        /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })
          ]
        })
...
function Achievements() {
  ...
  return /* @__PURE__ */ jsxs("section", {
    className: "relative py-28 bg-[var(--navy)] text-white overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxs("div", {
      className: "mx-auto max-w-7xl px-6 relative", children: [
      /* @__PURE__ */ jsxs("div", {
        ...
        /* @__PURE__ */ jsxs("h2", {
          className: "font-display font-black text-4xl lg:text-5xl mt-3", children: [
            "A track record of ",
      ...
      /* @__PURE__ */ jsx("div", {
        className: "mt-16 grid grid-cols-2 md:grid-cols-3 gap-px bg-white/10 rounded-2xl overflow-hidden", children: a.map((x) => /* @__PURE__ */ jsx(Reveal, {
          children: /* @__PURE__ */ jsxs("div", {
            className: "bg-[var(--navy)] p-10 hover:bg-[var(--navy-deep)] transition-colors group", children: [
...
function Programs() {
  ...
  return /* @__PURE__ */ jsx("section", {
    id: "programs", className: "py-28 bg-[var(--surface)]", children: /* @__PURE__ */ jsxs("div", {
      className: "mx-auto max-w-7xl px-6", children: [
    /* @__PURE__ */ jsxs("div", {
        className: "flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-14", children: [
      /* @__PURE__ */ jsxs("div", {
          children: [
      ...
      /* @__PURE__ */ jsxs("a", {
          href: "#", className: "font-button font-semibold text-[var(--navy)] inline-flex items-center gap-2 group", children: [
            "View All Programs ",
        /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4 group-hover:translate-x-1 transition" })
          ]
        })
    ...
    /* @__PURE__ */ jsx("div", {
        className: "grid md:grid-cols-2 lg:grid-cols-4 gap-6", children: progs.map((p, i) => /* @__PURE__ */ jsx(Reveal, {
          delay: i * 80, children: /* @__PURE__ */ jsxs("div", {
            className: "group relative bg-white rounded-2xl p-7 border border-[var(--navy)]/8 hover:border-[var(--navy)] transition-all duration-500 hover:-translate-y-2 hover:shadow-premium h-full flex flex-col", children: [
      ...
      /* @__PURE__ */ jsxs("dl", {
              className: "space-y-3 text-sm flex-1", children: [
        /* @__PURE__ */ jsxs("div", {
      ...
      /* @__PURE__ */ jsxs("a", {
              href: "#", className: "mt-7 inline-flex items-center justify-between text-sm font-button font-semibold text-[var(--navy)] group/btn", children: [
...
function WhyChoose() {
  ...
  return /* @__PURE__ */ jsx("section", {
    className: "py-28 bg-white", children: /* @__PURE__ */ jsxs("div", {
      className: "mx-auto max-w-7xl px-6", children: [
    /* @__PURE__ */ jsxs("div", {
    ...
    /* @__PURE__ */ jsx("div", {
        className: "grid md:grid-cols-2 lg:grid-cols-3 gap-5", children: f.map((x, i) => /* @__PURE__ */ jsx(Reveal, {
          delay: i * 60, children: /* @__PURE__ */ jsx("div", {
            className: "group relative h-full p-8 rounded-2xl glass-light hover:bg-white hover:shadow-premium hover:-translate-y-1 transition-all duration-500", children: /* @__PURE__ */ jsxs("div", {
...
function Research() {
  ...
  return /* @__PURE__ */ jsx("section", {
    id: "research", className: "py-28 bg-[var(--surface)]", children: /* @__PURE__ */ jsxs("div", {
      className: "mx-auto max-w-7xl px-6 grid lg:grid-cols-2 gap-16 items-center", children: [
    /* @__PURE__ */ jsx(Reveal, {
        children: /* @__PURE__ */ jsxs("div", {
          className: "relative", children: [
      ...
      /* @__PURE__ */ jsxs("div", {
            className: "absolute top-6 right-6 glass-light rounded-xl px-5 py-3 shadow-premium", children: [
    ...
    /* @__PURE__ */ jsxs(Reveal, {
      ...
      /* @__PURE__ */ jsx("div", {
          className: "mt-10 space-y-4", children: r.map((x) => /* @__PURE__ */ jsxs("div", {
            className: "flex items-center justify-between p-4 rounded-xl bg-white border border-[var(--navy)]/8 hover:border-[var(--gold)] hover:shadow-premium transition group", children: [
        /* @__PURE__ */ jsxs("div", {
...
function Campus() {
  ...
  return /* @__PURE__ */ jsx("section", {
    id: "infrastructure", className: "py-28 bg-white", children: /* @__PURE__ */ jsxs("div", {
      className: "mx-auto max-w-7xl px-6", children: [
    /* @__PURE__ */ jsxs("div", {
        className: "flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-12", children: [
      /* @__PURE__ */ jsxs("div", {
          children: [
        ...
        /* @__PURE__ */ jsxs("h2", {
            className: "font-display font-black text-4xl lg:text-5xl text-[var(--navy)] mt-3 max-w-2xl leading-tight", children: [
    ...
    /* @__PURE__ */ jsx("div", {
        className: "relative overflow-hidden rounded-3xl shadow-premium aspect-[16/8]", children: slides.map((s, i) => /* @__PURE__ */ jsxs("div", {
          className: `absolute inset-0 transition-all duration-1000 ${i === idx ? "opacity-100 scale-100" : "opacity-0 scale-105"}`, children: [
      ...
      /* @__PURE__ */ jsxs("div", {
            className: "absolute bottom-0 left-0 right-0 p-8 lg:p-12 text-white", children: [
...
function Recruiters() {
  ...
  return /* @__PURE__ */ jsxs("section", {
    className: "py-20 bg-[var(--surface)] overflow-hidden border-y border-[var(--navy)]/8", children: [
    /* @__PURE__ */ jsxs("div", {
      className: "mx-auto max-w-7xl px-6 mb-10 text-center", children: [
...
function Placements() {
  ...
  return /* @__PURE__ */ jsx("section", {
    id: "placements", className: "py-28 bg-white", children: /* @__PURE__ */ jsxs("div", {
      className: "mx-auto max-w-7xl px-6", children: [
    /* @__PURE__ */ jsxs("div", {
        className: "text-center max-w-3xl mx-auto mb-16", children: [
    ...
    /* @__PURE__ */ jsx("div", {
        className: "grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16", children: cards.map((c, i) => /* @__PURE__ */ jsx(Reveal, {
          delay: i * 80, children: /* @__PURE__ */ jsxs("div", {
            className: "group p-7 rounded-2xl bg-[var(--surface)] hover:bg-[var(--navy)] hover:text-white transition-all duration-500 hover:-translate-y-1 h-full", children: [
    ...
    /* @__PURE__ */ jsx("div", {
        className: "grid grid-cols-2 lg:grid-cols-4 gap-px bg-[var(--navy)]/10 rounded-2xl overflow-hidden border border-[var(--navy)]/10", children: [
          { v: 95, s: "%", l: "Placement Rate" },
          { v: 12, s: "LPA", l: "Highest Package" },
          { v: 4, s: ".8", l: "Average Package" },
          { v: 150, s: "+", l: "Recruiting Partners" }
        ].map((x) => /* @__PURE__ */ jsxs("div", {
          className: "bg-white p-8 text-center", children: [
...
function StudentLife() {
  ...
  return /* @__PURE__ */ jsx("section", {
    className: "py-28 bg-[var(--surface)]", children: /* @__PURE__ */ jsxs("div", {
      className: "mx-auto max-w-7xl px-6", children: [
    /* @__PURE__ */ jsxs("div", {
    ...
    /* @__PURE__ */ jsx("div", {
        className: "columns-1 md:columns-2 lg:columns-3 gap-5 space-y-5", children: items.map((it, i) => /* @__PURE__ */ jsx(Reveal, {
          children: /* @__PURE__ */ jsxs("div", {
            className: `group relative overflow-hidden rounded-2xl shadow-premium break-inside-avoid ${it.h}`, children: [
      ...
      /* @__PURE__ */ jsxs("div", {
              className: "absolute bottom-0 left-0 right-0 p-6 text-white", children: [
...
function Leadership() {
  const leaders = [
    { img: chairmanImg, name: "Smt. N. Sakuntala", qualification: "B.A.,", role: "Chairman", quote: "Education is the most powerful instrument we can place in the hands of tomorrow's healthcare leaders." },
    { img: secretaryImg, name: "Dr. N.V.V. Jagan Mohan Reddy", qualification: "M.Pharm, PhD", role: "Secretary & Correspondent", quote: "Our promise is simple \u2014 every student receives the mentorship, resources and opportunity to lead." }
  ];
  return /* @__PURE__ */ jsx("section", {
    className: "py-28 bg-white", children: /* @__PURE__ */ jsxs("div", {
      className: "mx-auto max-w-7xl px-6", children: [
    ...
    /* @__PURE__ */ jsx("div", {
        className: "grid md:grid-cols-2 gap-8", children: leaders.map((l, i) => /* @__PURE__ */ jsx(Reveal, {
          delay: i * 100, children: /* @__PURE__ */ jsxs("div", {
            className: "group bg-[var(--surface)] rounded-3xl p-8 lg:p-10 hover:shadow-premium transition-all duration-500 flex flex-col sm:flex-row gap-7 items-start h-full", children: [
      /* @__PURE__ */ jsxs("div", {
      ...
      /* @__PURE__ */ jsxs("div", {
        ...
        /* @__PURE__ */ jsxs("p", {
                className: "text-[var(--ink)] leading-relaxed italic", children: [
                  '"',
                  l.quote,
                  '"'
                ]
        ...
        /* @__PURE__ */ jsxs("div", {
          ...
          /* @__PURE__ */ jsx("div", { className: "font-display font-bold text-[var(--navy)]", children: l.name }), <span className="text-sm text-[var(--muted-ink)]">{l.qualification}</span>,
          /* @__PURE__ */ jsx("div", { className: "text-sm text-[var(--muted-ink)]", children: l.role })
                ]
              }),
        /* @__PURE__ */ jsxs("a", {
                href: "#", className: "mt-5 inline-flex items-center gap-2 text-sm font-button font-semibold text-[var(--navy)] group/btn", children: [
                  "View Message ",
...
function Testimonials() {
  ...
  return /* @__PURE__ */ jsxs("section", {
    ...
    /* @__PURE__ */ jsxs("div", {
      className: "mx-auto max-w-5xl px-6 relative", children: [
      /* @__PURE__ */ jsxs("div", {
      ...
      /* @__PURE__ */ jsx("div", {
        className: "relative h-[340px]", children: t.map((s, k) => /* @__PURE__ */ jsx("div", {
          className: `absolute inset-0 transition-all duration-700 ${k === i ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6 pointer-events-none"}`, children: /* @__PURE__ */ jsxs("div", {
            className: "glass rounded-3xl p-8 lg:p-12 h-full flex flex-col lg:flex-row gap-8 items-center", children: [
        ...
        /* @__PURE__ */ jsxs("div", {
              className: "flex-1 text-center lg:text-left", children: [
          ...
          /* @__PURE__ */ jsxs("p", {
                className: "text-lg lg:text-xl leading-relaxed text-white/90 italic", children: [
                  '"',
                  s.text,
                  '"'
                ]
          ...
          /* @__PURE__ */ jsxs("div", {
            ...
            /* @__PURE__ */ jsxs("div", {
                  className: "text-sm text-[var(--gold)]", children: [
                    s.role,
                    " \xB7 ",
                    s.co
                  ]
...
function VirtualTour() {
  return /* @__PURE__ */ jsx("section", {
    id: "tour", className: "relative py-28 bg-white", children: /* @__PURE__ */ jsx("div", {
      className: "mx-auto max-w-7xl px-6", children: /* @__PURE__ */ jsxs("div", {
        className: "relative overflow-hidden rounded-3xl shadow-premium aspect-[16/9] group cursor-pointer", children: [
    ...
    /* @__PURE__ */ jsxs("div", {
          className: "relative h-full flex flex-col items-center justify-center text-white text-center p-6", children: [
      ...
      /* @__PURE__ */ jsxs("h2", {
            className: "font-display font-black text-4xl lg:text-6xl max-w-3xl leading-[1.05]", children: [
              "Explore our campus ",
      ...
      /* @__PURE__ */ jsxs("button", {
            className: "mt-8 group/btn relative h-20 w-20 rounded-full bg-[var(--gold)] grid place-items-center hover:scale-110 transition-transform shadow-gold-glow", children: [
      ...
      /* @__PURE__ */ jsxs("a", {
            href: "#", className: "mt-6 inline-flex items-center gap-2 text-sm font-button font-semibold", children: [
              "Watch Tour ",
        /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })
            ]
          })
...
function FinalCTA() {
  return /* @__PURE__ */ jsxs("section", {
    id: "admission", className: "relative py-28 bg-[var(--navy-deep)] text-white overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxs("div", {
      className: "relative mx-auto max-w-4xl px-6 text-center", children: [
      /* @__PURE__ */ jsxs("div", {
        className: "inline-flex items-center gap-2 px-4 py-1.5 rounded-full glass text-xs font-medium tracking-wider uppercase mb-6", children: [
        /* @__PURE__ */ jsx(Calendar, { className: "h-3.5 w-3.5 text-[var(--gold)]" }),
          " Limited Seats \xB7 2026 Intake"
        ]
      }),
      /* @__PURE__ */ jsxs("h2", {
        className: "font-display font-black text-4xl lg:text-6xl leading-[1.05]", children: [
          "Start Your ",
      ...
      /* @__PURE__ */ jsxs("div", {
        ...
        /* @__PURE__ */ jsxs("a", {
          href: "#", className: "group inline-flex items-center gap-2 bg-[var(--gold)] text-[var(--navy-deep)] font-button font-semibold px-8 py-4 rounded-full shadow-gold-glow hover:-translate-y-0.5 transition-all", children: [
            "Apply Now ",
          /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4 group-hover:translate-x-1 transition" })
          ]
        }),
        /* @__PURE__ */ jsxs("a", {
          href: "#contact", className: "inline-flex items-center gap-2 glass text-white font-button font-medium px-8 py-4 rounded-full hover:bg-white/15 transition", children: [
      ...
      /* @__PURE__ */ jsxs("div", {
        className: "mt-10 text-sm text-white/60", children: [
...
function Footer() {
  return /* @__PURE__ */ jsxs("footer", {
    id: "contact", className: "bg-[var(--navy)] text-white pt-20 pb-8", children: [
    /* @__PURE__ */ jsxs("div", {
      className: "mx-auto max-w-7xl px-6 grid lg:grid-cols-4 md:grid-cols-2 gap-12", children: [
      /* @__PURE__ */ jsxs("div", {
        children: [
        /* @__PURE__ */ jsxs("div", {
          className: "flex items-center gap-3", children: [
      ...
      /* @__PURE__ */ jsxs("div", {
        ...
        /* @__PURE__ */ jsx("ul", {
          className: "space-y-3 text-sm text-white/75", children: ["About Us", "Admissions", "Faculty", "Research", "Campus Life", "News & Events"].map((x) => /* @__PURE__ */ jsx("li", {
            children: /* @__PURE__ */ jsxs("a", {
              href: "#", className: "hover:text-[var(--gold)] transition flex items-center gap-2 group", children: [
      ...
      /* @__PURE__ */ jsxs("div", {
        ...
        /* @__PURE__ */ jsx("ul", {
          className: "space-y-3 text-sm text-white/75", children: ["B.Pharm", "Pharm.D", "M.Pharm", "D.Pharm", "Ph.D Research"].map((x) => /* @__PURE__ */ jsx("li", {
            children: /* @__PURE__ */ jsxs("a", {
              href: "#", className: "hover:text-[var(--gold)] transition flex items-center gap-2 group", children: [
          /* @__PURE__ */ jsx(ChevronRight, { className: "h-3 w-3 opacity-0 group-hover:opacity-100 transition" }),
                x
      ...
      /* @__PURE__ */ jsxs("div", {
        ...
        /* @__PURE__ */ jsxs("ul", {
          className: "space-y-4 text-sm text-white/75", children: [
          /* @__PURE__ */ jsxs("li", {
        ...
        /* @__PURE__ */ jsxs("div", {
          ...
          /* @__PURE__ */ jsxs("form", {
            className: "flex gap-2", onSubmit: (e) => e.preventDefault(), children: [
    ...
    /* @__PURE__ */ jsxs("div", {
      className: "mx-auto max-w-7xl px-6 mt-16 pt-6 border-t border-white/10 flex flex-col md:flex-row gap-3 justify-between items-center text-xs text-white/55", children: [
      /* @__PURE__ */ jsxs("div", {
        children: [
          "\xA9 ",
